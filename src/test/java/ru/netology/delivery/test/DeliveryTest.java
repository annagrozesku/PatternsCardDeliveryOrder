...
public class DeliveryTest {
    ...
    @Test
    @DisplayName("Should show an error message when an invalid name is entered")
    void shouldShowErrorMessage() {
        ...
        $("[data-test-id=agreement]").click();
        $$("button").find(exactText("Запланировать")).click();
        $("[data-test-id=phone] .input__sub").shouldHave(exactText("Указан неверный номер телефона"));
    }
}
